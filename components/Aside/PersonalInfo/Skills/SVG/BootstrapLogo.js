  ...
  const SVG = ({ currentColors }) =>
    (<svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 512 408">
      <defs>
        ...
        >
          <stop stopColor={currentColors.grayColor} />
          <stop offset={1} stopColor={currentColors.darkGrayColor} />
        </linearGradient>
        <linearGradient
          id="b"
          x1={193.508}
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor={currentColors.backgroundColor} />
          <stop offset={1} stopColor={currentColors.backgroundColor} />
        </linearGradient>
        <filter
